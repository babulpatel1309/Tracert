...
public class MainActivity_Appintro extends AppCompatActivity {
...
//        window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        CirclePageIndicator_Intro mIndicator = (CirclePageIndicator_Intro) findViewById(R.id.indicator);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity_Appintro.this, MainActivity.class);
