...
public class CustomFrndList extends BaseAdapter {
    ...
    public CustomFrndList(Activity activity,
                          ArrayList<FriendCheckList> arrayList_appointments, String s) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        pending = (Button) rowView.findViewById(R.id.pending);
